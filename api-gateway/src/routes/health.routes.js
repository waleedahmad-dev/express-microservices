...
const services = {
  ...
  'chat-service': process.env.CHAT_SERVICE_URL || 'http://chat-service:3005'
};
...
router.get('/detailed', async (req, res) => {
  ...
  const checkPromises = Object.entries(services).map(async ([name, url]) => {
    try {
